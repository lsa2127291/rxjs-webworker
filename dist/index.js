(function (global, factory) {
	...
	(factory((global.RxWorker = {})));
}(this, (function (exports) { 'use strict';

// creates an inline web worker
var createWorker = function createWorker(worker) {
 ...
 */
var fromWorker = function fromWorker(webWorker) {
  var initMessage = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'init';
...
// creates an inline web worker
var createInlineWorker = function createInlineWorker(fn) {
  var blob = new Blob(['self.cb = ', fn.toString(), ';', 'self.onmessage = function (e) { self.postMessage(self.cb(e.data)) }'], {
 ...
 * @param {Function} fn
 */
var mapWorker = function mapWorker(fn) {
  return function (source) {
    return new Observable(function (observer) {
      var workerString = fn.toString();
      var worker = void 0;
      ...
      worker.onmessage = function (e) {
        return observer.next(e.data);
      };
      worker.onerror = function (err) {
        return observer.next(err);
      };
      return source.subscribe(function (value) {
        return worker.postMessage(value);
      });
    });
  };
};
